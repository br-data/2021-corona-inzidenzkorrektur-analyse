...
````
Das Filtern nach Datenstand > 180 entfernt rund 16.000 von 26.000 Einträgen. Die Durchschnittswerte erscheinen im gesamten höher - gegen die intuitive Erwartung, dass Abweichungen bei sinkenden Fallzahlen kleiner werden. 

Für die folgende Tabelle wurden die 80 Landkreise (20%) herausgenommen, die im betrachteten Zeitraum (seit dem 1. März) die größte Durchschnittsinzidenz (mean) hatten. Dabei fallen lediglich 5200 Einträge heraus  (80*65)  (Datenstand: 4. Mai 2021)
...
data_diff_d %>% 
  pivot_longer(names_to="Art", values_to="Delta_Med", 8:13) %>%
  filter(Art %in% c("delta_1_median","delta_3_median","delta_5_median"))%>%
