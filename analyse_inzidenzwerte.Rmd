...
````
Das Filtern nach Datenstand > 180 entfernt rund 4600 von rund 27.000 Einträgen /Datenstand: 5. Mai 2021). Die Durchschnittswerte erscheinen im gesamten höher - gegen die intuitive Erwartung, dass Abweichungen bei sinkenden Fallzahlen kleiner werden. 

Für die folgende Tabelle wurden die 80 Landkreise (20%) herausgenommen, die im betrachteten Zeitraum (seit dem 1. März) die größte Durchschnittsinzidenz (mean) hatten. Dabei fallen lediglich 5200 Einträge heraus  (80*65)  (Datenstand: 5. Mai 2021)
