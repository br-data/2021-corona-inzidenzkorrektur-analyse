...
Durchschnitte <- data.frame(Zeitraum = c("nach 1 Tag","nach 3 Tagen", "nach 5 Tagen", "nach 14 Tagen"), durschn_veraenderung = c(mean(abs(data_diff$delta_1), na.rm = TRUE),mean(abs(data_diff$delta_3), na.rm = TRUE),mean(abs(data_diff$delta_5), na.rm = TRUE),mean(abs(data_diff$delta_I4), na.rm = TRUE)),median_veraenderung = c(median(abs(data_diff$delta_1), na.rm = TRUE),median(abs(data_diff$delta_3), na.rm = TRUE),median(abs(data_diff$delta_5), na.rm = TRUE),median(abs(data_diff$delta_I4), na.rm = TRUE))) 
...
data_diff_lk <- data_diff %>% 
  ...
  summarise_at(vars(delta_1,delta_3, delta_5,delta_I4), funs(mean, median, max), na.rm = TRUE)
