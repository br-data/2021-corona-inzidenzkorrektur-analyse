...
data_diff_bl %>% 
  gather("Tage", "Mean_Delta", 2:7) %>%
  ggplot(aes(x=Tage,y=Mean_Delta, group=Bl))+
  geom_point() +
  facet_wrap(.~Bl)+
  theme(legend.position = "none")

data_diff_bl %>% 
  gather("Tage", "Median_Delta", 8:13) %>%
  ggplot(aes(x=Tage,y=Median_Delta, group=Bl))+
  geom_point() +
  facet_wrap(.~Bl)+
  theme(legend.position = "none")

data_diff_bl %>% 
  gather("Tage", "Quantile_Delta", 14:19) %>%
  ggplot(aes(x=Tage,y=Quantile_Delta, group=Bl))+
  geom_point() +
  facet_wrap(.~Bl)+
  theme(legend.position = "none")
